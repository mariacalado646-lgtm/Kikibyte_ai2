  ...
  return (
    <div style={{ padding: "2rem" }}>
      ...
      <div className="d-flex align-items-center justify-content-between flex-wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <div className="d-flex align-items-center" style={{ gap: "0.75rem" }}>
          <a href="/admin/clients" className="btn-kb-outline-sm">Clientes</a>
          <a href="/admin/gestors" className="btn-kb-outline-sm">Gestores</a>
          <a href="/admin/content" className="btn-kb-outline-sm">Conteúdo</a>
          <a href="/admin/imports" className="btn-kb-outline-sm">Importar</a>
          <a href="/admin/reports" className="btn-kb-outline-sm">Relatórios</a>
        </div>
      </div>
